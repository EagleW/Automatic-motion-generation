...
def main():
    ...
    for filename_char in fileList_char:
        ...
        for animName in fileList:
            ...
            x = "Camera"
            myCamera = FBCamera(x)
            myCamera.SetVector( FBVector3d( camera["pos"][0][0], camera["pos"][0][1], camera["pos"][0][2] ) )
            myCamera.SetVector( FBVector3d( camera["rotate"][0][0], camera["rotate"][0][1], camera["rotate"][0][2] ), FBModelTransformationType.kModelRotation)
            myCamera.BackGroundColor = FBColor(1,1,1)
